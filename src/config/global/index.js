...
addCustomProps(ToastView.type, { successIcon: Images.icon_toast_success, failIcon: Images.icon_toast_fail, warnIcon: Images.icon_toast_warn, loadingIcon: Images.icon_toast_loading });
addCustomProps(Checkbox.type, { narmalIcon: Images.icon_nav_left, selectIcon: Images.icon_center_play });
